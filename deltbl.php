...
<head>
	...
	<style>
		table a:hover{border:2px solid red;color:black;padding:2% 4% 2% 4%;text-decoration:none;border-radius:0px;background:red;color:#fff;}
	</style>
</head>
<body>
					...
					<div class="panel panel-info">
						<div class="panel-body">
								...
								<thead>
									<tr>
										...
										<?php
											...
											{
										?>
							            	<td ><a href='deltbl.php?id=<?php echo $row[0];?>'><?php echo $row[$l];?></a></td>
										<?php
											}
										?>
							            </tr>
							...
							<ul class="pagination pagination-sm pull-right">
								<?php
									echo "<li><a href='deltbl.php?page=1'>".'|'."<span class='glyphicon glyphicon-chevron-left'></span></a></li> "; // Goto 1st page
									for ($i=1; $i<=$total_pages; $i++)
									{ 
            								echo "<li><a href='deltbl.php?page=".$i."'>".$i."</a></li> "; 
									} 
									echo "<li><a href='deltbl.php?page=$total_pages'><span class='glyphicon glyphicon-chevron-right'></span>".'|'."</a> </li>"; // Goto last page
								?>
							</ul>
						</div>
					</div>
