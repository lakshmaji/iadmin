    ...
    <div id="main-wrapper" data-theme="light" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full" data-sidebar-position="fixed" data-header-position="fixed" data-boxed-layout="full">
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                                                    ...
                                                    ?>
                                                        ...
                                                        <td>
                                                            <div class="d-flex">
                                                                <?php
                                                                // check last column
                                                                    echo "<a class='btn btn-info mr-2' href='../edit/preedit.php?id=".base64_encode($row[0])."'>edit</a>";
                                                                    echo "<a class='btn btn-danger' href='index.php?id=".$row[0]."'>delete</a>";  
                                                                ?>
                                                            </div>
                                                        </td>
                                                        <?php
                ...
                <?php 
                    $sql = "SELECT COUNT(*) as total_rows FROM ".$selected_table_name; 
                    $rs_result = mysqli_query($connection_ref, $sql); //run the query
                    $total_records = 0;
                    if ($rs_result) {
                        ...
                        echo "Error executing query: " . mysqli_error($connection_ref);
                    }
